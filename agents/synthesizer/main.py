...
class SynthesizerAgent(BaseAgent):
    ...
    async def handle(self, routed_query: dict[str, Any]) -> dict[str, Any] | None:
        ...
        await self._publish_status(session_id, query, "started", detail=f"Waiting for {len(sibling_agents)} agents...")
        ...
        await self._publish_status(session_id, query, "started", detail="Resolving location and KPIs...")
